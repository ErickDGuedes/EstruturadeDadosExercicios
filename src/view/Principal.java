...
public class Principal {
	...
	public static void main(String[] args) {
		...
		while(opc != 9) {
			...
			int a = 3;
			int b = 3;
			JOptionPane.showMessageDialog(null, "Resultado da Multiplicação ==> "+op.Ex1(a, b));
			break;
			...
			int Divid = 13;
			int Divis = 5;
			JOptionPane.showMessageDialog(null, "Resultado do Resto da Divisão ==> "+op.Ex2(Divid, Divis));
			break;
			...
			JOptionPane.showMessageDialog(null, "Quantidade de Num. Pares ==> "+op.Ex3(Vet, Len - 1));
			break;
			//Fecha o Menu
